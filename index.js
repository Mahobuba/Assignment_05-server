...
const uri =
  `mongodb+srv://${process.env.DB_USER}:${process.env.DB_SECRET}@test.qs7np.mongodb.net/?retryWrites=true&w=majority&appName=test`;
...
async function run() {
  try {
    ...
    const orderCol = client.db("totTheMasterDB").collection("orders"); 
